...
- [Sorting algorithms](https://github.com/vishnukumarbp/algorithmsjs#sorting-algorithms)
  ...
  * [Radix sort](https://github.com/vishnukumarbp/algorithmsjs#radix-sort)
...
## Radix sort
Special sorting algorithm which works on list of numbers. This algorithm never compares two values. It exploits the fact that the size of a number is encoded in the number of digit. i.e, More digits means a bigger number.

It works by creating 0 to 9 buckets. Take a digit from number from right to left, and based on the value, put inside the bucket, and concat each bucket at the end of each loop.

This algorithm considered as equal or better than other algorithms. 
Time complexity is O(nk) where k is the higgest number of digit (for eg. 10, 2, 10233 => k = 5)
